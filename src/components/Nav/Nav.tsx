          ...
          <>
            <li className={styles.item}>
              <NavLink
                ...
                to="https://github.com/YevhenProtasov/nice-gadgets"
                target="_blank"
            ...
            <li className={styles.item}>
              <NavLink
                to="https://www.linkedin.com/in/yevhen-p-23b2a4136"
                target="_blank"
                className={`${styles.link} ${styles.link_m_footer}`}
            ...
            <li className={styles.item}>
              <NavLink
                to="/rights"
                className={`${styles.link} ${styles.link_m_footer} ${styles.rights}`}
